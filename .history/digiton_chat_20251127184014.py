...
def simulate_chat_sequence():
    ...
    wavfile.write('data/digiton_chat_spin.wav', SAMPLE_RATE, (wav_data * 32767).astype(np.int16))
    print("Saved audio to data/digiton_chat_spin.wav")
    ...
    print("-" * 60)
    print("Visualization saved to 'data/06_digiton_chat_sequence.png'")
    ...
    wavfile.write('data/06_digiton_chat_sequence.wav', fs, signal_int16)
    print("Audio saved to 'data/06_digiton_chat_sequence.wav'")
