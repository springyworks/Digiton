...
## 13. The "Deep Spin" (-60dB)

**Date:** November 27, 2025
**Agent:** GitHub Copilot (Gemini 3 Pro)

We combined "Deep Mode" (Coherent Integration) with "SDR Spin" to achieve detection at **-60dB SNR**.

*   **The Setup:**
    *   **Symbol:** Right Spin (+200Hz).
    *   **Repetitions:** 1024 pulses.
    *   **Channel:** -60dB Watterson Fading.
*   **The Process:**
    1.  Receiver stacks the 1024 noisy intervals on top of each other.
    2.  The noise (random) averages out. The signal (coherent) builds up.
    3.  The stacked signal is then fed into the SDR Downconverter.
*   **The Result (`data/17_digiton_deep_spin.png`):**
    *   **Raw Audio:** Pure white noise. Zero visibility.
    *   **Stacked Audio:** A clear Gaussian pulse emerges!
    *   **SDR Output:** The frequency trace locks onto **+200Hz**.
*   **Conclusion:** We can detect "Spin" (Left/Right) even at -60dB, provided we have enough time to repeat the signal. This confirms the user's hypothesis: "Spin" carries detectable information even in the harshest conditions.
