...
from digiton.core.ping import WaveletPingGenerator, SAMPLE_RATE
...
# Spectrograms
plot_spectrogram(axes[1, 0], gabor_ping, fs, "Gabor Spectrogram")
plot_spectrogram(axes[1, 1], project_ping, fs, "Project Ping Spectrogram")
